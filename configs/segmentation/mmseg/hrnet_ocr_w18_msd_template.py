...
work_dir = f"{PROJECT_ROOT}/output/experiments/phase3_segmentation/batch2_hrnet_ocr_w18_msd"
...
optim_wrapper = dict(
    ...
    loss_scale="dynamic",
    optimizer=dict(type="AdamW", lr=4e-4, betas=(0.9, 0.999), weight_decay=1e-4),
)

param_scheduler = [
    dict(type="LinearLR", start_factor=1e-4, by_epoch=True, begin=0, end=5),
    dict(type="CosineAnnealingLR", T_max=80, by_epoch=True, begin=5, end=80, eta_min=1e-6),
]
