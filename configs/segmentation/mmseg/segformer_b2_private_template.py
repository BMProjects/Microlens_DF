...
work_dir = f"{PROJECT_ROOT}/output/experiments/phase3_segmentation/batch2_segformer_b2_private"
...
param_scheduler = [
    dict(type="LinearLR", start_factor=1e-5, by_epoch=True, begin=0, end=3),
    dict(type="CosineAnnealingLR", T_max=40, by_epoch=True, begin=3, end=40, eta_min=1e-6),
]

train_cfg = dict(type="EpochBasedTrainLoop", max_epochs=40, val_interval=4)
